...
5. [**Compras de emergencia sin ETL**](docs/05-compras-emergencia.md) — canal rápido y controlado para compras urgentes: mini-formulario, código PRE, aprobación ágil y regularización pre-llenada al portafolio.
